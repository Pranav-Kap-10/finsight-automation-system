# 🌍 FinSight-Automation-System  
> A complete end-to-end **Global Economic Intelligence & Investment Analytics Platform** that automates IMF data ingestion, transformation, risk modeling, and dashboard-driven investment decision support.
...
The system eliminates manual consolidation and enables **real-time economic monitoring across 196 countries**.
...
### 2️⃣ Consolidation Engine (Apps Script)  
...
### 3️⃣ Misery Index (Investment Risk Indicator)  
...
- Replaced '--' with Null  
- Removed fully null rows (2019–2025)  
- Unpivoted year columns  
- Cleaned and standardized subject descriptors  
